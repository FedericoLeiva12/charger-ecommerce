      ...
      <ThemeProvider theme={darkTheme}>
        <div className={classes.cont}>
          ...
          >
            ...
            <div>
                <Container setAlert={setAlert} products={products.map(prod => ({image: prod.imgs[0].url, title: prod.name, price: prod.price, id: prod.id, stock: prod.stock, categories: prod.categories}))} />
            </div>
        </div>
      </ThemeProvider>
      <Snackbar
